...
SELECT
 bd.delivery_date
 ,bd.shop_code
 ,bd.subtotal_price -- 税前销售额
 ,bd.order_count      -- 订单数量
 ,bd.coupon                -- 优惠券使用额
 ,bd.point                  -- 点数使用额
 ,bd.tax_price -- 税金额
 ,bd.shipping_cost  -- 运费金额
 ,bd.envelope_cost   -- 信封金额
 ,ODD.original_price -- 原价之和
 ,ODD.sku_count -- sku 的数量
 ,ALF_DATA.afl_order_count -- 博主带货的订单数量
 ,ALF_DATA.afl_rewards -- 博主带货的奖励支出
 ...
 ,padd.pointsawarded  --ポイント付与 [付与ポイント]
FROM ORDER_DATA bd
